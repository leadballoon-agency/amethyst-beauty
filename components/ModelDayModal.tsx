...
export default function ModelDayModal({ isOpen, onClose }: ModelDayModalProps) {
  ...
  const whatsappMessage = encodeURIComponent('Hi! I\'d like to apply to be a model for CO2 laser treatment. Can you let me know if there are any current opportunities?')
        ...
        <div className="p-6 sm:p-8">
          <div className="space-y-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-neutral-800 mb-1">Apply to Be a Model</h4>
                <p className="text-sm text-neutral-600">We're always looking to expand our results gallery. Discounts may be available if you match what we're currently looking for.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-neutral-800 mb-1">Portfolio Needs Vary</h4>
                <p className="text-sm text-neutral-600">Depending on the age, treatment area, or skin type we need for our gallery, we may offer a discount on your treatment.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">Models receive the exact same professional treatment - performed by our expert practitioners with full aftercare support.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl p-4 mb-6 text-center">
            <p className="text-sm text-primary-700 mb-1">Discounts Available</p>
            <p className="text-xl font-bold text-primary-600">Based on Portfolio Needs</p>
            <p className="text-xs text-primary-600/80 mt-1">Message us to see if you qualify</p>
          </div>
